...
<head>
	...
	<link rel="icon" href="<?php echo base_url('assets/images/SIRARM-logo-light.png') ?>" type="image/ico" />
...
<body class="nav-md">
		...
		<div class="main_container">
			...
			<footer>
				<div class="pull-right">
					<a href="https://http://rsh.fkh.ugm.ac.id/main/">SIRARM</a> <?php echo $footer; ?>
				</div>
				<div class="clearfix"></div>
			</footer>
			<!-- /Footer Content -->
	...
	<script>
		...
		$(document).ready(function() {
			$("#errorAlert").fadeTo(5000, 500).slideUp(500, function() {
